...
// The function should have two parameters, arrayOfDrivers and the function you wrote in test 3(?).
//  Then you would want to return that function you wrote in test 3 with the parameter being arrayOfDrivers